               ...
               6 -> {
                   ...
                   if (baseModel.data.spouses.size==0){
                       ...
                       if (LanguageChange.langA == "en"){
                           ...
                           boxList.add(Box(getString(R.string.religion), getString(R.string.religion), baseModel.data.spouses[n].religion.g_name()))
                           ...
                           boxList.add(Box(getString(R.string.religion), getString(R.string.religion), baseModel.data.spouses[n].religion.g_name_bn()))
                       }
