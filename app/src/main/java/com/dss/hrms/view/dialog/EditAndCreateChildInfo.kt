...
class EditAndCreateChildInfo {
    var dialogCustome: Dialog? = null
    var childs: Employee.Childs? = null
    ...
    fun showDialog(
        ...
        updateEducationQualification(context, childs1)
        dialogCustome?.show()
    ...
    fun updateEducationQualification(
        ...
        binding?.fChildrenNameOChEn?.etText?.setText(childs1?.name_of_children)
        binding?.fChildrenNameOChBn?.etText?.setText(childs1?.name_of_children_bn)
        binding?.fChildrenBirthCertificateNo?.etText?.setText(childs1?.birth_certificate)
        binding?.fChildrenNidNo?.etText?.setText(childs1?.nid)
        binding?.fChildrenPassportNo?.etText?.setText(childs1?.passport)
        binding?.fChildrenDOB?.tvText?.setText(childs1?.date_of_birth)
        ...
        CommonRepo(MainActivity.appContext).getCommonData("/api/auth/gender/list",
