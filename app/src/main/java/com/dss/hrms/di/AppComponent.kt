...
import com.dss.hrms.BaseApplication
...
@Singleton
@Component(
    modules = [AndroidSupportInjectionModule::class, ContextModule::class, AppModule::class, ApiModule::class, ActivityBuildersModule::class,
